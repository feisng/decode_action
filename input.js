...
// @version      1.9
// @description  【重大更新】新增手机号登录功能！支持微信扫码和手机号验证码两种登录方式。优化了登录界面，提供更好的用户体验。修正了.bin文件名显示不全的BUG。增强了对无后缀名JSON账号文件的支持。
// @author       苏御
